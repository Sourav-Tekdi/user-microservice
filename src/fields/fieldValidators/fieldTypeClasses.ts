...
import { Field, FieldAttributes, Option } from "./fieldClass";

export class DropdownField extends Field {
    constructor(fieldAttributes: FieldAttributes, fieldParams: Option[]) {
...
export class RadioField extends Field {
    ...
    validate(value: any): boolean {
        const fieldParamsOptions = this.fieldParams.map(({ value }) => value)
